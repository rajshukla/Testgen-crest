...
# 1 "<command-line>" 2
# 1 "./uniform_test.cil.c"
# 15 "/home/raj/Desktop/uniform_test.c"
...
int main(void)
{
  ...
  __CrestCall(1, 1);
# 17 "/home/raj/Desktop/uniform_test.c"
  __CrestInt(& a);
# 18 "/home/raj/Desktop/uniform_test.c"
  __CrestInt(& b);
# 19 "/home/raj/Desktop/uniform_test.c"
  __CrestInt(& c);
# 20 "/home/raj/Desktop/uniform_test.c"
  __CrestInt(& d);
  __CrestLoad(4, (unsigned long )(& a), (long long )a);
  __CrestLoad(3, (unsigned long )0, (long long )5);
  __CrestApply2(2, 12, (long long )(a == 5));
# 21 "/home/raj/Desktop/uniform_test.c"
  if (a == 5) {
    __CrestBranch(5, 3, 1);
    {
...
# 22 "/home/raj/Desktop/uniform_test.c"
    if (b == 19) {
...
# 23 "/home/raj/Desktop/uniform_test.c"
      if (c == 7) {
...
# 24 "/home/raj/Desktop/uniform_test.c"
        if (d == 4) {
          __CrestBranch(20, 6, 1);
# 25 "/home/raj/Desktop/uniform_test.c"
...
# 31 "/home/raj/Desktop/uniform_test.c"
  __retres5 = 0;
