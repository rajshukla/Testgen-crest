...
Example commands to test the "test/uniform_test.c" program:
    ...
    ../bin/run_crest ./uniform_test 10 -dfs 0  (or     ../bin/run_crest ./uniform_test 10 -dfs)

    (the third argument = number of iterations)
    (the fifth argument = number of given test cases)
